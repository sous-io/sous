...
description: >
  ...
  Claude Code skill. Covers skill structure, core frontmatter, invocation, topic vs
...
This "topical skill" provides information about two things: the Claude Code skills system —
