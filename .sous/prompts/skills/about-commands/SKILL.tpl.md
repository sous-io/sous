...
If `$ARGUMENTS` is not present in the body but arguments are passed, {{ toolName }} appends them automatically as `ARGUMENTS: <value>`. Full substitution syntax is in `about-agent-skills/references/substitutions.md`.
